...
class Post {
        ...
        if($check_empty != "") {
            ...
            foreach($body_array as $key => $value) {
                ...
                if(strpos($value, "www.youtube.com/watch?v=") !== false ) {
                    ...
                    $value = "<br><iframe width=\'620\' height=\'350\' src=\'" . $value ."\'></iframe><br>";
    ...
    public function loadPostsFriends($data, $limit) {
        ...
        if(mysqli_num_rows($data_query) > 0) {
            ...
            $num_iteration = 0; //Number of results check(not necasserily posted)
            $count = 1;
        ...
        while($row = mysqli_fetch_array($data_query)) {
            ...
            //Once 10 pots have been loaded break
            if($count > $limit) {
                break;
            }
            else {
    ...
    public function getSinglePost($post_id) {
        ...
        echo "<p>No post found. If clicked it may be broken</p>";
                  return;
    }
