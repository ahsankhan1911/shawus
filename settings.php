...
<div class="main_column column">
    ...
    <form action="settings.php" method="POST">
        First Name: <input type="text" name="first_name" value="<?php echo $first_name; ?>" autocomplete="off" id="settings_input"><br>
        Last Name: <input type="text" name="last_name" value="<?php echo $last_name; ?>" autocomplete="off" id="settings_input"><br>
        Email: <input type="text" name="email" value="<?php echo $email; ?>" autocomplete="off" id="settings_input"><br>
    ...
    <form action="settings.php" method="POST">
        ...
        <input type="submit" name="update_password" id="save_details" value="Update Password" class="success settings_submit"><br>
    </form>
